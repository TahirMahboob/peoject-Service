...
import BlogImage from '../../assests/images/Satellite.jpg';
...
function Sattlite() {
  ...
  return (
    <>
      <Hero text="Sattelite" text1="services" image={BlogImage} />


      {/* cleaning professions */}
      <div className="text-center mt-36">
        <p className="text-[#ED5521] text-4xl font-semibold"> Satellite</p>
      ...
      <div>
        ...
        <div className="text-center lg:text-left lg:ml-60  lg:mt-0">
          <h1 className="text-xl lg:text-2xl font-semibold  lg:mt-16">
            Basic House Cleaning Services in Satellite Town
          </h1>
        </div>
