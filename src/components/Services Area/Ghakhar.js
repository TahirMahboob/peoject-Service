...
function Ghakhar() {
  return (
    <>
      <Hero text="Ghakhar" text1="services" image={BlogImage} />

      {/* cleaning professions */}
      <div className="text-center mt-36">
        <p className="text-[#ED5521] text-4xl font-semibold"> Ghakhar</p>
        ...
        <p className="text-[16px] md:text-[20px] mt-4 text-neutral-500 leading-custom mb-2">
          The most skilled, dedicated and highly-rated cleaning professionals in
          your area. Guranteed.
        </p>
        <Link to="/book">
      ...
      <div>
        ...
        <div className="text-center lg:text-left lg:ml-60  lg:mt-0">
          <h1 className="text-xl lg:text-2xl font-semibold  lg:mt-16">
            Basic House Cleaning Services in Ghakhar
          </h1>
        </div>
        <div className="text-center lg:text-left lg:ml-60 mt-4 lg:mt-6">
          <p className="text-[16px] md:text-[20px] mt-4 text-neutral-500">
            For basic house cleaning services or office cleaning services,
            choose the Basic Cleaning to
